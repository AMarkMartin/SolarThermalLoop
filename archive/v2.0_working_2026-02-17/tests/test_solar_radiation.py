...
class TestSolarPosition:
    ...
    def test_solar_position_symmetry(self):
        ...
        # Altitudes should be nearly equal
        assert abs(alt_morning - alt_afternoon) < 1.0, \
...
class TestClearSkyRadiation:
    ...
    def test_maximum_irradiance_at_high_altitude(self):
        ...
        # ~1000-1100 W/m² at sea level
        assert 900 < irrad < 1200, f"Clear sky DNI {irrad} W/m² should be 900-1200"
